...
test.describe('No-circle screen', () => {
  ...
  test('unauthenticated visit to /timeline redirects to /no-circle when no membership', async ({
    page,
  }) => {
  ...
  test('authenticated user with membership is redirected away from /no-circle to /timeline', async ({
    page,
  }) => {

    ...
    >
      ...
      >
        ...
        <button
          ...
          class="flex h-11 w-11 items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-sm transition-colors hover:bg-black/60"
        ...
        <!-- Save to device -->
        <button
          class="flex h-11 w-11 items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-sm transition-colors hover:bg-black/60 disabled:opacity-50"
          ...
          <div class="mb-2">
            ...
            >
              ...
              <div class="mb-3 space-y-2">
                ...
                >
                  ...
                  >
                    ...
                    <span
                      v-if="slide.id === memory.cover_media_id"
              ...
              <div v-if="!showAddTextSlide" class="text-center">
                <button
                  type="button"
                  class="text-[11px] font-medium text-accent hover:opacity-70"
              ...
              <div v-else class="space-y-2">
                <textarea
                  ...
                  rows="3"
                  maxlength="2000"
                  class="w-full resize-none rounded-lg bg-secondary px-3 py-2 text-base text-foreground outline-none placeholder:text-muted-foreground focus:ring-1 focus:ring-accent/40"
                />

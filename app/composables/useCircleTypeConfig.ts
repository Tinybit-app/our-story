...
export function useCircleTypeConfig(
  ...
  if (t) {
    ...
    return {
      ...
      milestonePlaceholder: t(`circleTypeConfig.${typeKey}.milestonePlaceholder`),
      milestoneShort: t('upload.milestoneShort'),
      milestoneChips: chips,
    }
  }

  const fallback = circleType && EN_FALLBACK[circleType] ? EN_FALLBACK[circleType]! : EN_DEFAULT
